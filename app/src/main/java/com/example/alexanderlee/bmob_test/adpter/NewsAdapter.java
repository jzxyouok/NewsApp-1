package com.example.alexanderlee.bmob_test.adpter;
...
import com.example.alexanderlee.bmob_test.NewsActivity;
...
public class NewsAdapter extends RecyclerView.Adapter<NewsAdapter.NewsViewHolder>{
    ...
    public NewsAdapter.NewsViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v= LayoutInflater.from(context).inflate(R.layout.news,viewGroup,false);
        NewsViewHolder nvh=new NewsViewHolder(v);
        return nvh;
    }

    @Override
    public void onBindViewHolder(NewsAdapter.NewsViewHolder personViewHolder, int i) {
        final int j=i;
